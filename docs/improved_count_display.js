...
// Wait for the DOM to be fully loaded before updating counts
window.addEventListener('DOMContentLoaded', function() {
  console.log("DOM fully loaded - updating protocol counts");
...
// Add a fallback to ensure counts are updated even if DOMContentLoaded already fired
setTimeout(function() {
  console.log("Fallback timer - ensuring protocol counts are updated");
